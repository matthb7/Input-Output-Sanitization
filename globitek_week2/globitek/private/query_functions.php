<?php
  ...
  function validate_country($country, $errors=array()) {
    ...
    } elseif (preg_match('/\A[A-Za-z ]+\Z/', $country['name']) == 0) {
      $errors[] = "Country name can only contain letters and spaces";
    }

    /* My Custom Validation */
    if (is_blank($country['code'])) {
      $errors[] = "Country code cannot be blank.";
    } elseif (!has_length($country['code'], array('min' => 1, 'max' => 3))) {
      $errors[] = "Country code must be between 1 and 3 characters.";
    } elseif (preg_match('/\A[A-Za-z]+\Z/', $country['code']) == 0) {
      $errors[] = "Country code can only contain letters";
    }
  ...
  function validate_state($state, $errors=array()) {
    ...
    } elseif (preg_match('/\A[A-Za-z ]+\Z/', $state['name']) == 0) {
      $errors[] = "State name can only contain letters and spaces";
    }

    /* My Custom Validation */
    if (is_blank($state['code'])) {
      $errors[] = "State code cannot be blank.";
    } elseif (!has_length($state['code'], array('min' => 1, 'max' => 3))) {
      $errors[] = "State code must be between 1 and 3 characters.";
  ...
  function validate_territory($territory, $errors=array()) {
    ...
    } elseif (preg_match('/\A[A-Za-z ]+\Z/', $territory['name']) == 0) {
      $errors[] = "Territory name can only contain letters and spaces";
    }
    ...
    } elseif (preg_match('/\A[A-Za-z]+\Z/', $territory['position']) == 0) {
      $errors[] = "Territory position can only contain letters";
    }
  ...
  function validate_salesperson($salesperson, $errors=array()) {
    ...
    } elseif (preg_match('/\A[A-Za-z]+\Z/', $salesperson['first_name']) == 0) {
    ...
    } elseif (preg_match('/\A[A-Za-z]+\Z/', $salesperson['last_name']) == 0) {
    ...
    } elseif (preg_match('/\A[0-9()-]+\Z/', $salesperson['phone']) == 0) {
      $errors[] = "Phone can only contain numbers, and symbols: [()-]";
    }
    ...
    } elseif (preg_match('/\A[A-Za-z0-9_@\.-]+\Z/', $salesperson['email']) == 0) {
      $errors[] = "Email can only contain letters, numbers, and symbols: [_@.-]";
    }
  ...
  function validate_user($user, $errors=array()) {
    if (is_blank($user['first_name'])) {
      ...
      $errors[] = "First name must be between 2 and 255 characters.";
    } elseif (preg_match('/\A[A-Za-z]+\Z/', $user['first_name']) == 0) {
      $errors[] = "First name can only contain letters";
    }
    ...
    if (is_blank($user['last_name'])) {
      ...
      $errors[] = "Last name must be between 2 and 255 characters.";
    } elseif (preg_match('/\A[A-Za-z]+\Z/', $user['last_name']) == 0) {
      $errors[] = "Last name can only contain letters";
    }
    ...
    if (is_blank($user['email'])) {
      ...
      $errors[] = "Email must be a valid format.";
    } elseif (preg_match('/\A[A-Za-z0-9_@\.-]+\Z/', $user['email']) == 0) {
      $errors[] = "Email can only contain letters, numbers, and symbols: [_@.-]";
    }
    ...
    } elseif (preg_match('/\A[A-Za-z0-9_]+\Z/', $user['username']) == 0) {
