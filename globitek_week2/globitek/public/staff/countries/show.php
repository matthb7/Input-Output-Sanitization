...
?>
    <br />
    <a href="edit.php?id=<?php echo h($country['id']); ?>">Edit</a><br />
    <hr />

    <h2>States</h2>
    <br />
    <a href="../states/new.php?id=<?php echo h($country['id']); ?>">Add a State</a><br />
...
<?php
    ...
    while($state = db_fetch_assoc($state_result)) {
      echo "<li>";
      echo "<a href=\"../states/show.php?id=" . h($state['id']) . "\">";
      echo h($state['name']);
      echo "</a>";
      echo "</li>";
    } // end while $state
